            ...
            <div className="2xl:px-20 md:px-10 2xl:mx-auto 2xl:container">
                <div className="md:py-12 py-8 px-4 ">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-xl leading-normal text-center text-gray-600 mt-4 xl:w-1/2 w-10/12">{trustPartners.subHeading}</p>
                    </div>
                    <div className="flex items-center justify-center mt-10">
                        <div
                            className="flex flex-col md:flex-row items-center justify-center">

                            {trustPartners.partners.map((partner, index) => <PartnerBrand key={index}
                                                                                          image={partner.logo}
                                                                                          altText={partner.description}/>)}
                        </div>
                    </div>
                </div>
            </div>
