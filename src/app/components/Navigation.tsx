...
const solutions = [
    ...
    {
        name: "Offshore",
        description: "Build strategic work-streams to drive your growth",
                            ...
                            >
                                {({open}) => (
                                    <>
                                        ...
                                        >
                      <span
                          className="hover:border-b-2 uppercase hover:border-b-primaryBlue hover:ease-in hover:duration-300 px-6 pb-2">
                        Consulting
                      </span>
                                        </Popover.Button>
                            ...
                            >
                <span
                    className="hover:border-b-2 px-6 pb-2 hover:border-b-primaryBlue hover:ease-in hover:duration-300 border-primaryBlue focus:border-b-2 focus:border-primaryBlue">
                  Staffing
                </span>
                            </Link>
                            <div className="px-4">
