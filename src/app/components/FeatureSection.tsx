...
export default function Feature() {
  return (
    <div className="bg-white my-8 py-4 sm:py-4">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  <div className="absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg bg-primaryBlue">
                    <feature.icon
  ...
  return (
    <div className="my-8 p-2 py-8 sm:p-4 bg-primaryBlue overflow-hidden shadow-sm shadow-blue-500 ">
      <div className="flex flex-col sm:flex-row items-center justify-between">
        <div className=" ">
          <div className="flex flex-col md:items-start items-center justify-center px-2 sm:px-4 py-4 md:py-24 ">
