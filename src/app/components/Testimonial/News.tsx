...
function NewsArticle() {
    return <div className=''>
        ...
        <div className="py-6 border-b border-gray-200">
            <h2 className="text-2xl text-indigo-900 font-bold">Policy Level
                Decisions</h2>
            <p className="py-3 text-sm text-gray-700 leading-7">Our mission is
                to help people visualize, create & maintain beautiful homes. We
                bring to you inspiring visuals of cool homes and spaces. </p>
                    ...
                    <div className="flex items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width={18}
                                ...
                                <circle cx={9} cy={9} r="7.5" stroke="#718096"
                                        strokeWidth="1.25" strokeLinecap="round"
                                        strokeLinejoin="round"/>
                                <path d="M9 4.8335V9.00016L11.5 11.5002"
                                      stroke="#718096" strokeWidth="1.25"
                                      strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                        </div>
                        ...
                        <div className="lg:flex flex-wrap items-center">
                            <div className="lg:w-1/3 w-full pb-6 md:pb-0 md:pr-6">
                                <div className="w-full">
                                    <h1 className="text-2xl lg:text-4xl font-bold text-indigo-900 tracking-wider lg:w-11/12 leading-relaxed">InnovationSGP
                                        in the News</h1>
                                    <div className="py-4">
                                        ...
                                        >
                                            ...
                                            <div className="hidden lg:block lg:ml-8">
                                                <div className="relative h-96">
                                                    <img
                                                        className="absolute inset-0 object-cover object-center w-full h-full"
                                                        src="https://cdn.tuk.dev/assets/components/111220/events/eventsection2.png"
                                                        alt/>
                                                </div>
                                                <div className="py-6 border-b border-gray-200">
                                                    <h2 className="text-2xl text-indigo-900 font-bold">Policy Level
