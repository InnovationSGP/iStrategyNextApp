    ...
    <div>
      ...
      {/* <div>
        ...
        <div
          ...
          } bg-primaryBlue transform  xl:translate-x-0 shadow xl:rounded-r fixed h-full top-22 sm:z-20  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 flex-col `}
        >
          ...
          <div className="   mt-4 flex flex-col px-6 justify-start items-center w-full   ">
            ...
            <button className="focus:outline-none focus:text-white  flex justify-start items-center space-x-6   hover:text-white  text-indigo-200 rounded  py-3    w-full ">
              <svg
                width={24}
                height={24}
                viewBox="0 0 24 24"
